  ...
  return (
    <div className="mt-5 mb-3">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between gap-4">
        <div className="d-flex w-100 w-md-50 align-items-start gap-3 mb-4 mb-md-0">
          <div style={{ width: "15%" }}>
          ...
          <div style={{ width: "85%", maxWidth: "500px" }}>
            ...
            <Dropdown>
              <Dropdown.Toggle
                ...
                className="fw-semibold text-black bg-transparent d-flex align-items-start gap-1"
              >
        ...
        <div className="d-flex w-100 w-md-50 align-items-start gap-3 mb-4 mb-md-0">
          ...
          <div style={{ width: "85%", maxWidth: "500px" }}>
            ...
            <p>
              L'esportazione dei prodotti produce un file CSV contenente tutte le informazioni dei prodotti selezionati.
              Puoi modificare il file CSV con qualsiasi foglio di calcolo e reimportarlo nel tuo negozio per aggiornare il tuo catalogo interamente.
              Scopri di più sull'esportazione dei dati: Conoscenza di Base.
            </p>
      ...
      {/* Secondo gruppo */}
      <div className="d-flex flex-column flex-md-row justify-content-between gap-4 mt-5">
        <div className="d-flex w-100 w-md-50 align-items-start gap-3 mb-4 mb-md-0">
          <div style={{ width: "15%" }}>
            <GrDocumentUpdate style={{ fontSize: "80px" }} />
          </div>
        ...
        <div className="d-flex w-100 w-md-50 align-items-start gap-3 mb-4 mb-md-0">
          ...
          <div style={{ width: "85%", maxWidth: "500px" }}>
            ...
            <p>
              Il nostro team di personalizzazione può aiutarti ad automatizzare l'aggiornamento dei prezzi,
              a sincronizzare le scorte con un sistema esterno di gestione dell'inventario e altro ancora.
            </p>
