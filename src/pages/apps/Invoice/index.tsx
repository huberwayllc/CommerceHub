...
const Invoice = () => {
	...
	return (
		<>
			<PageBreadcrumb subName="Apps" title="Invoice" />
			<Row>
					...
					<Card>
						...
						<CardBody>
							<Row className="row-cols-3 d-flex justify-content-md-between">
								<Col md="3" className="d-print-flex">
									<div>
										<h6 className="mb-0">
											<b>Order Date :</b> 11/05/2021
										</h6>
										<h6>
							...
							<Row className="d-flex justify-content-center">
								...
								<Col lg="12" xl="4">
									<div className="float-end d-print-none mt-2 mt-md-0 d-inline-flex gap-1">
										<Link
											to=""
											onClick={printPage}
