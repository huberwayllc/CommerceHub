...
const ResponsiveImages = () => {
	return (
		<ComponentContainerCard
			...
			description="Images in Bootstrap are made responsive with <code> .img-fluid. max-width: 100%; </code> and <code> height: auto; </code> are applied to the image so that it scales with the parent element."
		>
...
const ImageThumbnails = () => {
	return (
		<ComponentContainerCard
			...
			description="You can use <code> .img-thumbnail </code> to give an image a rounded."
		>
			<div className="media">
...
const ImageRounded = () => {
	return (
		<ComponentContainerCard
			title="Image rounded"
			description="You can use <code> .rounded </code> to give an image a rounded."
		>
			<div className="media">
...
const ImageCircle = () => {
	return (
		<ComponentContainerCard
			title="Image circle"
			description="You can use <code> .rounded-circle </code> to give an image a circle."
		>
			<div className="media">
...
const AligningImages = () => {
	return (
		<ComponentContainerCard
			...
			description="You can use <code> .float-end </code> and <code> .float-start </code> to give an image position."
		>
...
const CenterImage = () => {
	return (
		<ComponentContainerCard
			title="Aligning images"
			description="You can use <code> .d-block .mx-auto </code> image center."
		>
...
const Images = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Images" />
			<Row>
				<Col xs={12}>
					<ResponsiveImages />
				</Col>
