...
const ActiveItems = () => {
	return (
		<ComponentContainerCard
			title="Active items"
			description="Add <code> .active </code> to a <code> .list-group-item </code> to indicate the current active selection."
		>
			<Row>
				<Col lg={6}>
					<ListGroup>
...
const LinksAndButtons = () => {
	return (
		<ComponentContainerCard
			...
			description="Uses <code> < a > </code> or <code> < button /> </code> s to create actionable list group itemswith hover and active states by adding <code> .list-group-item-action. </code"
		>
			<Row>
				<Col lg={6}>
					<ListGroup>
...
const Horizontal = () => {
	return (
		<ComponentContainerCard
			title="Horizontal"
			description="Add <code> .list-group-horizontal </code> to remove some borders and rounded corners."
		>
			<Row>
				<Col lg={8}>
...
const Flush = () => {
	return (
		<ComponentContainerCard
			title="Flush"
			description="Add <code> .list-group-flush </code> to remove some borders and rounded corners."
		>
			<Row>
				<Col lg={6}>
...
const List = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Lists" />
			<Row>
				<Col lg={6}>
					<BasicExample />
				</Col>
