...
const OutlineBadges = () => {
	return (
		...
		>
			<div className="d-flex align-align-items-center gap-1">
				<Badge className="badge-outline-primary">Primary</Badge>
				<Badge className="badge-outline-secondary">Secondary</Badge>
				<Badge className="badge-outline-success">Success</Badge>
				<Badge className="badge-outline-danger">Danger</Badge>
				<Badge className="badge-outline-warning">Warning</Badge>
				<Badge className="badge-outline-info">Info</Badge>
				<Badge className="badge-outline-purple">Purple</Badge>
				<Badge className="badge-outline-dark">Dark</Badge>
			</div>
		</ComponentContainerCard>
	)
}
...
const OutlinePillBadges = () => {
	return (
		...
		>
			<div className="d-flex align-align-items-center gap-1">
				<Badge pill className="badge-outline-primary">
					Primary
				</Badge>
				<Badge pill className="badge-outline-secondary">
					Secondary
				</Badge>
				<Badge pill className="badge-outline-success">
					Success
				</Badge>
				<Badge pill className="badge-outline-danger">
					Danger
				</Badge>
				<Badge pill className="badge-outline-warning">
					Warning
				</Badge>
				<Badge pill className="badge-outline-info">
					Info
				</Badge>
				<Badge pill className="badge-outline-pink">
					Pink
				</Badge>
				<Badge pill className="badge-outline-dark">
					Dark
				</Badge>
			</div>
		</ComponentContainerCard>
...
const Badges = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Badges" />
			<Row>
				<Col lg={6}>
					<BadgeExamples />
				</Col>
