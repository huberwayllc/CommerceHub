...
const SquareTextAvatar = () => {
	return (
		<ComponentContainerCard
			title="Text Avatar"
			description="Square Shape avatar text in soft color example"
		>
			<div className="d-flex align-items-center">
				<span className="thumb-xl justify-content-center d-flex align-items-center bg-soft-success rounded me-2">
					MT
				</span>
				<span className="thumb-lg justify-content-center d-flex align-items-center bg-soft-pink rounded me-2">
					MT
				</span>
				<span className="thumb-md justify-content-center d-flex align-items-center bg-soft-purple rounded me-2">
					MT
				</span>
				<span className="thumb-sm justify-content-center d-flex align-items-center bg-soft-warning rounded me-2">
					MT
				</span>
				<span className="thumb-xs justify-content-center d-flex align-items-center bg-soft-info rounded me-2">
					MT
				</span>
			</div>
		</ComponentContainerCard>
...
const SquareIconAvatar = () => {
	return (
		...
		>
			<div className="d-flex align-items-center">
				<span className="thumb-xl justify-content-center d-flex align-items-center bg-primary rounded me-2">
					<i className="far fa-grin-alt text-white" />
				</span>
				<span className="thumb-lg justify-content-center d-flex align-items-center bg-pink rounded me-2">
					<i className="far fa-user text-white" />
				</span>
				<span className="thumb-md justify-content-center d-flex align-items-center bg-purple rounded me-2">
					<i className="fab fa-mailchimp text-white" />
				</span>
				<span className="thumb-sm justify-content-center d-flex align-items-center bg-warning rounded me-2">
					<i className="fas fa-user text-white" />
				</span>
				<span className="thumb-xs justify-content-center d-flex align-items-center bg-info rounded me-2">
					<i className="fas fa-smile text-white" />
				</span>
			</div>
		</ComponentContainerCard>
...
const Avatars = () => {
	return (
		<>
			<PageBreadcrumb title="Avatar" subName="Ui Kit" />
			<Row>
				<Col lg={4}>
					<DefaultAvatar />
				</Col>
