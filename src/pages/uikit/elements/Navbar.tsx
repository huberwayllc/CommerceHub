...
const NavbarWithBrandImage = () => {
	...
	return (
		<ComponentContainerCard
			...
			description="Adding images to the <code> .navbar-brand </code> will likely always require custom styles or utilities to properly size. Here are some examples to demonstrate."
		>
			<nav className="navbar navbar-expand-lg navbar-light bg-light">
				<div className="container-fluid">
					<Link className="navbar-brand" to="">
...
const NavbarThemeColors = () => {
	...
	return (
		<ComponentContainerCard
			title="Theme colors"
			description="Theming the navbar has never been easier thanks to the combination of theming classes and <code> background-color </code> utilities."
		>
