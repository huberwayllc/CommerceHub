...
const DefaultButtons = () => {
	return (
		<ComponentContainerCard
			title="Default Buttons Examples"
			...
			<div className="button-items">
				{colorVariants.map((color, idx) => (
					<button
						type="button"
						key={idx}
						className={`btn btn-de-${color} me-2`}
					>
...
const DefaultDashedButtons = () => {
	return (
		<ComponentContainerCard
			title="Default Dashed Buttons"
			description="Bootstrap includes six predefined button styles, each serving its own semantic purpose."
		>
			<div className="button-items">
				{colorVariants.map((color, idx) => (
					<button
						type="button"
						key={idx}
						className={`btn btn-de-dashed-${color} me-2`}
					>
						{toSentenceCase(color)}
					</button>
				))}
...
const ButtonSizes = () => {
	return (
		<ComponentContainerCard
			...
			description="New extra larger or smaller buttons added <code> .btn-xl </code> or <code>.btn-sm </code> for additional sizes."
		>
			<div className="button-items">
...
const ButtonWithIcons = () => {
	return (
		<ComponentContainerCard
			...
			description="A button variant for using only icons Add <code> .btn-icon-square </code>"
		>
			<div className="button-items">
...
const CircleButtonWithIcons = () => {
	return (
		<ComponentContainerCard
			...
			description="A button variant for using only icons Add <code> .btn-icon-circle </code>"
		>
			<div className="button-items">
				<Button
...
const BlockButtons = () => {
	return (
		<ComponentContainerCard
			...
			description="Create block level buttons—those that span the full width of a parent—by adding <code> .d-grid. </code>"
		>
...
const Buttons = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Buttons" />
			<Row>
				<Col lg={6}>
					<DefaultButtons />
				</Col>
				<Col lg={6}>
					<DefaultDashedButtons />
				</Col>
			</Row>
			<Row>
				<Col lg={6}>
