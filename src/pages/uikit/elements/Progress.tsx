...
const StripedAndAnimatedStripes = () => {
	return (
		<ComponentContainerCard
			...
			description="Add <code> .progress-bar-animated </code> to <code> .progress-bar </code> to animate the stripes right to left via CSS3 animations."
		>
...
const LabelsAndMultipleBars = () => {
	return (
		<ComponentContainerCard
			...
			description="Add labels to your progress bars by placing text within the <code> .progress-bar. </code>"
		>
...
const HeightAndBackgroundProgressBar = () => {
	return (
		<ComponentContainerCard
			...
			description="We only set a <code> height </code> value on the <code> .progress-bar </code>, And add background color class."
		>
...
const VerticalExample = () => {
	return (
		<ComponentContainerCard
			...
			description="Add <code> .progress-vertical </code> to any <code> .progress-bar-animated </code> to apply a stripe via CSS gradient over the progress bar’s background color."
		>
			<Row>
