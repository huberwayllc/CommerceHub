...
const OptionalSizes = () => {
	...
	return (
		<ComponentContainerCard
			...
			description="Modals have three optional sizes, available via modifier classes to be placed on a <code> .modal-dialog. </code> "
		>
				...
				<table className="table table-bordered table-striped mb-0">
					...
					<tbody>
						<tr>
							...
							<td>
								<Button variant="de-primary" size="sm" onClick={toggle}>
									Launch demo modal
								</Button>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<Button variant="de-primary" size="sm" onClick={lgModalToggle}>
									Launch demo modal
								</Button>
							</td>
						</tr>
						<tr>
							...
							<td>
								<Button variant="de-primary" size="sm" onClick={xlModalToggle}>
									Launch demo modal
								</Button>
							</td>
						</tr>
			...
			>
				...
				<ModalFooter>
					<Button variant="de-secondary" size="sm" onClick={toggle}>
						Close
					</Button>
					<Button variant="de-primary" size="sm">
						Save changes
					</Button>
				</ModalFooter>
			</Modal>
			...
			>
				...
				<ModalFooter>
					<Button variant="de-secondary" size="sm" onClick={lgModalToggle}>
						Close
					</Button>
				</ModalFooter>
			</Modal>
			...
			>
				...
				<ModalFooter>
					<Button variant="de-secondary" size="sm" onClick={xlModalToggle}>
						Close
					</Button>
					<Button variant="de-primary" size="sm">
						Save changes
			...
			>
				...
				<ModalFooter>
					<Button variant="de-secondary" size="sm" onClick={centerModalToggle}>
						Close
					</Button>
					<Button variant="de-primary" size="sm">
						Save changes
			...
			>
				...
				<ModalFooter>
					<Button variant="de-secondary" size="sm" onClick={scrollModalToggle}>
						Close
					</Button>
					<Button variant="de-primary" size="sm">
						Save changes
...
const FullscreenModals = () => {
	...
	return (
		<ComponentContainerCard
			...
			description="Another override is the option to pop up a modal that covers the user viewport, available via modifier classes that are placed on a <code> .modal-dialog </code>."
		>
			<div className="table-responsive">
				<table className="table table-bordered table-striped mb-0">
					<thead>
	...
	return (
		...
		>
			<div className="button-items">
				...
				<Button variant="de-info" onClick={() => openModalWithClass('info')}>
					Info
				</Button>
				<Button
					variant="de-danger"
				...
				<Button variant="de-dark" onClick={() => openModalWithClass('dark')}>
					Dark
				</Button>
			</div>
			...
			>
				...
				<ModalFooter>
					...
					<Button variant={`de-${className}`} size="sm">
						Save changes
					</Button>
				</ModalFooter>
			</Modal>
...
const LoginAndSignupModal = () => {
	...
	return (
		...
		>
			<Button variant="de-primary" onClick={toggle} className="me-1">
				Login demo modal
			</Button>
			<Button variant="de-primary" onClick={toggle}>
				Signup demo modal
			</Button>
			<Modal
				show={isOpen}
										...
										<Row className="form-group mb-0">
											<Col xs={12} className="mt-2">
												<div className="d-grid">
													<button
														className="btn btn-de-primary btn-block"
														type="submit"
													>
...
const Modals = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Modals" />
			<Row>
				<Col xs={12}>
					<OptionalSizes />
				</Col>
