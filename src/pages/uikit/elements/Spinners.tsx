...
const SpinnersSizes = () => {
	...
	return (
		<ComponentContainerCard
			title="Size"
			description="Add <code>.spinner-border-sm </code> and <code>.spinner-grow-sm .thumb-md </code> to make a smaller spinner that can quickly be used within other components."
		>
			<Row>
				{(sizes || []).map((size, idx) => {
					return (
...
const CustomSpinners = () => {
	return (
		<ComponentContainerCard
			...
			description="you can use custom border spinner, only add <code> .spinner-border-custom-1 /2 /3</code>."
		>
...
const CustomIconSpinners = () => {
	return (
		<ComponentContainerCard
			title="Custom spinners"
			description="You can use custom icon spinners"
		>
			<Row>
				<Col md={3}>
