...
const DisabledAndActivePagination = () => {
	return (
		<ComponentContainerCard
			...
			description="Pagination links are customizable for different circumstances. Use <code> .disabled </code> for links that appear un-clickable and <code> .active </code> to indicate the current page."
		>
			<nav aria-label="...">
				<ul className="pagination">
...
const SizingExample = () => {
	return (
		<ComponentContainerCard
			...
			description="Fancy larger or smaller pagination? Add <code> .pagination-lg </code> or <code> .pagination-sm </code> for additional sizes."
		>
			<nav aria-label="...">
				<Pagination size="lg">
...
const Paginations = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Pagination" />
