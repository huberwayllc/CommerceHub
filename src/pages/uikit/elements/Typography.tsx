...
const Heading = () => {
	return (
		<ComponentContainerCard
			title="Heading"
			description="All HTML headings, <code> < h1 > </code> through <code> < h6 > </code>, are available."
		>
...
const Typography = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Typography" />
			<Row>
				<Col lg={6}>
					<Row>
						<Col lg={6}>
				...
				<Col lg={6}>
					<Row>
						<Col lg={6}>
							<Card>
								<CardHeader>
									<CardTitle as="h4">Unorder List</CardTitle>
									<p className="text-muted mb-0">
						...
						<Col lg={6}>
							<Card>
								<CardHeader>
									<CardTitle as="h4">Unstyleed List</CardTitle>
									<p className="text-muted mb-0">
						...
						<Col lg={6}>
							<Card>
								<CardHeader>
									<CardTitle as="h4">Inline List</CardTitle>
