...
const BaseNav = () => {
	return (
		<ComponentContainerCard
			title="Base Nav"
			description="Navigation available in Bootstrap share general markup and styles, from the base <code> .nav </code> class to the active and disabled states."
		>
			<Nav className="nav">
				<NavItem>
...
const NavTabs = () => {
	return (
		<ComponentContainerCard
			title="Nav Tabs"
			description="Takes the basic nav from above and adds the <code> .nav-tabs </code> class to generate a tabbed interface."
		>
...
const NavJustified = () => {
	return (
		<ComponentContainerCard
			title="Nav Justified"
			description="For equal-width elements, use <code> .nav-justified</code>."
		>
...
const NavPills = () => {
	return (
		<ComponentContainerCard
			title="Nav Pills"
			description="Takes the basic nav from above and adds the <code> .nav-pills </code> class to generate a tabbed interface."
		>
...
const Navs = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Navs" />
