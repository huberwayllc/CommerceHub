...
const DropupVariationDropdowns = () => {
	return (
		<ComponentContainerCard
			...
			description="Trigger dropdown menus above elements by adding <code> .dropup </code> to the parent element."
		>
...
const DropendVariationDropdowns = () => {
	return (
		<ComponentContainerCard
			...
			description="Trigger dropdown menus above elements by adding  <code> .dropend </code> to the parent element."
		>
			<div className="button-items d-flex gap-1 dropup align-items-center">
...
const MenuAlignmentDropdown = () => {
	return (
		<ComponentContainerCard
			...
			description="Add <code> .dropdown-menu-end </code> to a <code> .dropdown-menu </code> to right align the dropdown menu."
		>
			<div className="button-items d-flex gap-1 dropup align-items-center">
...
const DroStartVariationDropdowns = () => {
	return (
		<ComponentContainerCard
			title="Dropend Variation Examples"
			description="Trigger dropdown menus above elements by adding <code> .dropstart </code> to the parent element."
		>
			<div className="button-items d-flex gap-1 dropup align-items-center">
...
const Dropdowns = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Dropdowns" />
			<Row>
				<Col lg={6}>
					<DropdownVariants />
				</Col>
