...
const GridExample = () => {
	return (
		<ComponentContainerCard
			title="Grid-Example"
			description="Using a single set of <code> .col-sm-* </code> classes, you can create a basic grid system that starts out stacked on extra small devices before becoming horizontal on desktop (medium) devices"
		>
...
const OffsetGrid = () => {
	return (
		<ComponentContainerCard
			...
			description="Move columns to the right using <code> .offset-md-* </code> classes. These classes increase the left margin of a column by * columns. For example, <code> .offset-md-4 </code> moves <code> .col-md-4 </code> over four columns. With the move to flexbox in v4, you can use margin utilities like <code> .mr-auto </code> to force sibling columns away from one another."
		>
			<div className="text-center">
				<Row>
...
const Grids = () => {
	return (
		<>
			<PageBreadcrumb subName="UI Kit" title="Grid" />
			<Row>
				<Col xs={12}>
					<GridOptions />
				</Col>
