					...
					<Card>
						<CardHeader>
							...
							<p className="text-muted mb-0">
								And you can even trigger SweetAlert2 popups declaratively! Use
								the bindClickHandler() method for that:
							</p>
						</CardHeader>
						<CardBody>
							<Button
						...
						<CardBody>
							{iconAlerts.map((alert, idx) => {
								return (
									<Button
										className="me-1"
										variant={`de-${alert.variant === 'error' ? 'danger' : alert.variant}`}
										key={idx}
										type="button"
										size="sm"
										onClick={() =>
												...
												onClick={() =>
													swal.fire({
														...
														html:
															...
															'<a href="https://Mannatthemes.com/">links</a> ' +
															'and other HTML tags',
